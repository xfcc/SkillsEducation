  ...
  subpackages: [
    {
      ...
      name: 'theory-course',
      pages: ['course/index', 'case/index', 'class/index', 'guidebook/index', 'camp/index', 'task/index'],
    },
    {
      root: 'subpackages/practice-tasks',
      name: 'practice-tasks',
      pages: ['quiz/index', 'leaderboard/index', 'utility-pvc/index', 'utility-aifv/index'],
    },
    {
