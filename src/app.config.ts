export default defineAppConfig({
  ...
  subpackages: [
    ...
    },
    {
      ...
      name: 'secondary',
      pages: [
        'home-notifications/index',
        'home-search/index',
        'home-frontier-filter/index',
        'home-frontier-detail/index',
        'home-live/index',
        'course-detail/index',
        'case-detail/index',
        'class-detail/index',
        'guidebook-detail/index',
        'simulator/index',
        'daily-quiz-detail/index',
        'profile-my-cases/index',
        'profile-live-signup/index',
        'profile-favorites/index',
        'profile-basic/index',
        'profile-tags/index',
        'profile-history/index',
        'profile-feedback/index',
